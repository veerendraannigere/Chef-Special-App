...
export class DealsDetailsService {
    constructor(private appconstants: AppConstants, private httpClient: HttpClient) {

    }
    public getDealsDetails(detailId): Observable<Response> {
        let url: string = this.appconstants.baseUrl + this.appconstants.getdealDeatailsUrl+'/'+detailId;
