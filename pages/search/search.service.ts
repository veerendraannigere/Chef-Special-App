...
export class SearchService {
    ...
    public getLoaction(searchText): Observable<Response> {
        let url: string = this.appconstants.baseUrl + this.appconstants.localitybyautocompleteUrl+'?search_key='+searchText;
